...
def death_screen(janela):
    
    janela.fill((0, 0, 0))
    title_fnt = pygame.font.Font('Assets/Font/PressStart2P.ttf', 55)
    text_surface = title_fnt.render("GAME OVER", True, (220, 20, 60))
    text_rect = text_surface.get_rect()
    text_rect.midtop = (WIDTH-775,  HEIGHT/ 2 - 50)
    janela.blit(text_surface, text_rect.midtop)

    title_fnt = pygame.font.Font('Assets/Font/PressStart2P.ttf', 20)
    text_surface = title_fnt.render("SCORE: score", True, (255, 255, 255))
    text_rect = text_surface.get_rect()
    text_rect.midtop = (WIDTH-650,  HEIGHT/ 1.5 )
    janela.blit(text_surface, text_rect.midtop)
